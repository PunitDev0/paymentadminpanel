...
const LPGDashboard = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.log('Fetched LPG Data:', result);
  ...
  console.log('Chart Data:', { dates, amountTrend, successRateTrend, refundedTrend });
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h1 className="text-2xl font-bold text-gray-800">LPG Dashboard</h1>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 overflow-hidden">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Refunded Amount Trend</h3>
                <div className="h-64">
                  {dates.length > 0 ? (
                    <Line
                      data={refundedChartData}
                      options={chartOptions}
                      aria-label="Refunded Amount Trend Chart"
                    />
                  ) : (
                    <p className="text-sm text-gray-500 text-center">No data available</p>
                  )}
                    ...
                    <div key={index} className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">Amount: ₹{operator.amount.toLocaleString()}</p>
                        </div>
                      </div>
                    ...
                    {filteredData.length > 0 ? (
                      filteredData.map((item, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="p-3 border-b">{item.message || 'N/A'}</td>
